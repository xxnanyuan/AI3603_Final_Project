...
def parse_args():
    ...
    parser.add_argument("--target-network-frequency", type=int, default=300,
...
if __name__ == "__main__":
    ...
    rb = ReplayBuffer(
        args.buffer_size,
        gym.spaces.Box(-1, 1, shape=(72,),dtype=float),
        envs.action_space,
        device,
