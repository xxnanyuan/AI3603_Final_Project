...
"""
    ...
    writer = SummaryWriter(f"runs/{times}")
    writer.add_text(
        "hyperparameters",
    ...
    # env setup
    envs = gym.vector.SyncVectorEnv([make_highway_env(args.env_id, args.seed, 0, args.capture_video, run_name)])
