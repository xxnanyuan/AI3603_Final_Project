...
def parse_args():
    ...
    parser.add_argument("--policy-lr", type=float, default=0.001,
        help="the learning rate of the policy network optimizer")
    parser.add_argument("--q-lr", type=float, default=0.001,
    ...
    parser.add_argument("--init-e", type=float, default=2,
            help="Entropy regularization coefficient.")
    parser.add_argument("--init-alpha", type=float, default=0.4,
            help="Entropy regularization coefficient.")
